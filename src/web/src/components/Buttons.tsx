...
(
    <Link className="link btn btn-primary mb-4" title="Elenco persone" to="/customers">
...
export const AddButton = () => (
    <Link className="link add btn btn-primary mb-4" to="/add" title="Aggiungi nuovo">
...
export const UserProfileButton = () => (
    // <Link className="link btn btn-primary" to="/profile" title="Profilo utente">
