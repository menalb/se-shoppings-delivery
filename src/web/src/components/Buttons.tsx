...
export const AddButton = (props: { to: string }) => (
    <Link className="link add btn btn-primary mb-4" to={props.to} title="Aggiungi nuovo">
...
export const DeliveriesButton = () => (
    <Link className="link btn btn-primary mb-4" to="/deliveries" title="Sezione Giri">
